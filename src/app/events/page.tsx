...
// 1. Featured Flagship Event (VIAJE 2027)
const featuredEvent = {
  title: "Viaje 2027",
  ...
  image: "https://images.unsplash.com/photo-1540039155732-d6824b5ce01d?auto=format&fit=crop&q=80&w=2000", // Add your photo path here
...
const megaEvents = [
  {
    title: "Freshers 2026",
    status: "Start of the Era",
    category: "Celebration",
    description: "The ultimate welcome to Karnavati University. Massive DJ sets, stunning visual installations, and the beginning of your greatest chapter.",
    image: "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?auto=format&fit=crop&q=80&w=800",
    gradient: "from-cyan-500 to-blue-600",
    glow: "rgba(34, 211, 238, 0.4)",
  },
  {
    title: "IEEE-CICON 2026",
    status: "Tech Summit",
    category: "Technology",
    description: "Dive into the cutting edge of cybersecurity, AI, and computing. Connect with industry leaders and witness the future of tech unfold.",
  ...
  },
  {
    ...
    status: "Global Convention",
    category: "Design & Innovation",
    description: "A masterclass in aesthetics and functionality. Explore physical product design, UI/UX, and architectural marvels.",
    image: "https://images.unsplash.com/photo-1561070791-2526d30994b5?auto=format&fit=crop&q=80&w=800",
    gradient: "from-pink-500 to-rose-500",
    glow: "rgba(244, 63, 94, 0.4)",
  },
  {
    title: "KU Garba Mahotsav",
    status: "Cultural Phenomenon",
    category: "Festival",
    description: "The most vibrant night of the year. Traditional beats meet modern energy in an unforgettable celebration of dance and culture.",
  ...
  },
  {
    ...
    description: "Push yourself to the absolute limit in this high-stakes campus showdown. Only the sharpest minds will dominate.",
...
const inductions = [
  ...
  { title: "UIM (BBA Hons) Induction", status: "Welcome", category: "Management", description: "The official welcome for the Unitedworld Institute of Management BBA freshers.", image: "", gradient: "from-emerald-400 to-teal-500", glow: "rgba(52, 211, 153, 0.4)" },
  { title: "UIM (MBA) Induction", status: "Welcome", category: "Management", description: "The official welcome for the Unitedworld Institute of Management MBA freshers.", image: "", gradient: "from-teal-500 to-emerald-600", glow: "rgba(20, 184, 166, 0.4)" },
  ...
  { title: "UIT (B.Tech) Induction", status: "Welcome", category: "Technology", description: "The official welcome for the Unitedworld Institute of Technology freshers.", image: "", gradient: "from-slate-400 to-zinc-600", glow: "rgba(148, 163, 184, 0.4)" },
];

// Reusable Card Component mapping photos correctly
const EventCard = ({ event }: { event: any }) => (
  <div 
    ...
    style={{ boxShadow: `0 0 0px ${event.glow}` }}
    onMouseEnter={(e) => e.currentTarget.style.boxShadow = `0 10px 40px ${event.glow}`}
    onMouseLeave={(e) => e.currentTarget.style.boxShadow = `0 0 0px ${event.glow}`}
  >
    {/* Photo or Gradient Background */}
    <div className={`relative w-full h-48 bg-gradient-to-br ${event.gradient} overflow-hidden flex items-center justify-center`}>
      {event.image ? (
        <img 
          src={event.image} 
          alt={event.title} 
  ...
  return (
    <>
      ...
      <main className="relative min-h-screen bg-black text-white overflow-hidden pb-32">
        ...
        {/* 2. Flagship Events Section */}
        <section className="relative z-10 max-w-7xl mx-auto px-6 mb-24">
          <div className="flex items-center justify-between mb-12 border-b border-white/10 pb-6">
            <h2 className="text-3xl font-black text-white tracking-wide uppercase">Flagship Events</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {megaEvents.map((event, index) => <EventCard key={index} event={event} />)}
          </div>
        </section>

        {/* 3. Festivals & Celebrations Section */}
        <section className="relative z-10 max-w-7xl mx-auto px-6 mb-24">
          <div className="flex items-center justify-between mb-12 border-b border-white/10 pb-6">
            <h2 className="text-3xl font-black text-white tracking-wide uppercase">Festivals & Celebrations</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {festivals.map((event, index) => <EventCard key={index} event={event} />)}
          </div>
        </section>

        {/* 4. Summits & Conclaves Section */}
        <section className="relative z-10 max-w-7xl mx-auto px-6 mb-24">
          <div className="flex items-center justify-between mb-12 border-b border-white/10 pb-6">
            <h2 className="text-3xl font-black text-white tracking-wide uppercase">Summits & Conclaves</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {summits.map((event, index) => <EventCard key={index} event={event} />)}
          </div>
        </section>

        {/* 5. The Induction Series Section */}
        <section className="relative z-10 max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between mb-12 border-b border-white/10 pb-6">
            <h2 className="text-3xl font-black text-white tracking-wide uppercase">The Induction Series</h2>
          </div>
