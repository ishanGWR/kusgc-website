  ...
  },
  {
    ...
    rows: [
      [
        ...
        { role: "Creative ", name: "Kanishk rathi", dept: "UID", image: "/council/Kanishk.jpg", insta: "kanishkrathi029" },
        { role: "Creative ", name: "Amatrra sengupta", dept: "UID", image: "/council/Amatrra.jpg", insta: "23_amatrra_" },
      ...
      <main className="relative min-h-screen bg-black text-white overflow-hidden pb-32">
        ...
        {councilData.map((group, groupIndex) => (
          <section key={groupIndex} className="relative z-10 max-w-[90rem] mx-auto px-6 mb-32">
            ...
            {/* Section Title */}
            {!group.hideHeading && (
              <div className="flex items-center justify-center mb-16 px-2">
                <div className="h-[1px] w-full max-w-xs bg-gradient-to-r from-transparent to-white/20 hidden sm:block" />
                <h2 className="mx-4 sm:mx-6 text-center text-xl sm:text-2xl md:text-3xl font-black uppercase tracking-wider sm:tracking-[0.2em] text-zinc-200 drop-shadow-md">
                  {group.section}
                </h2>
                <div className="h-[1px] w-full max-w-xs bg-gradient-to-l from-transparent to-white/20 hidden sm:block" />
              </div>
            )}
