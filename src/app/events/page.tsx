...
// 3. All Other Events
const allEvents = [
  { title: "Freshers 2026", status: "Start of the Era", category: "Celebration", description: "The ultimate welcome to Karnavati University. Massive DJ sets, stunning visual installations, and the beginning of your greatest chapter.", image: "/events/Fresherx.jpg", gradient: "from-cyan-500 to-blue-600", glow: "rgba(34, 211, 238, 0.4)" },
  ...
  { title: "KU Garba Mahotsav", status: "Cultural Phenomenon", category: "Festival", description: "The most vibrant night of the year. Traditional beats meet modern energy in an unforgettable celebration of dance and culture.", image: "/events/KUGM.jpg", gradient: "from-orange-500 to-amber-500", glow: "rgba(245, 158, 11, 0.4)" },
  ...
  { title: "Krishna Janmashtami", status: "Cultural", category: "Festival", description: "Traditional Dahi Handi, midnight aarti, and vibrant cultural performances.", image: "/events/Janmasthmi.JPG", gradient: "from-cyan-500 to-blue-600", glow: "rgba(6, 182, 212, 0.4)" },
...
const EventCard = ({ event }: { event: any }) => (
  <div
    className="group relative flex flex-col justify-between rounded-3xl border border-white/10 bg-zinc-900/50 backdrop-blur-md overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:border-white/30 min-h-[420px] h-auto sm:h-[420px]"
  ...
  >
    <div className="relative w-full h-48 flex-shrink-0 bg-zinc-900 overflow-hidden flex items-center justify-center">
      {event.image ? (
        <img
          src={event.image}
          alt={event.title}
        ...
        <section className="relative z-10 max-w-7xl mx-auto px-6 mb-16">
          <div className="group relative rounded-3xl border border-white/10 bg-white/5 p-2 backdrop-blur-xl transition-all duration-500 hover:border-cyan-500/50 hover:shadow-[0_0_50px_rgba(34,211,238,0.2)]">
            <div className="flex flex-col lg:flex-row items-center gap-8 bg-black/60 rounded-2xl overflow-hidden p-6 lg:p-10">
              ...
              <div className="w-full lg:w-1/2 aspect-video rounded-xl bg-zinc-900 relative overflow-hidden flex items-center justify-center shadow-2xl">
                {featuredEvent.image ? (
                  <img
