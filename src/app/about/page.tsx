            ...
            <div className="bg-black/80 backdrop-blur-2xl rounded-[23px] p-8 md:p-16 border border-white/5 shadow-2xl">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-6 text-zinc-400 text-lg leading-relaxed">
                  ...
                  <p>
                    Composed of passionate leaders from diverse departments, KUSGC is the driving force behind the university's most iconic flagship events, cultural festivals, tech summits, and social initiatives. From the vibrant energy of Garba Mahotsav to the intellectual rigor of global design conventions, we curate environments where students can thrive, network, and build core memories.
                  </p>
