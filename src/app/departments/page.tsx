...
const committeesData = [
  ...
  },
  {
    ...
    members: [
      ...
      { name: "Pranya Mehr", image: "/commities/operation/Pranya.jpg", insta: "pranyamehr" },
      ...
      { name: "Dhruvi Sakhiya", image: "/commities/operation/Dhruvi.jpeg", insta: "dhruvi_patel_152" },]
  },
  {
    id: "cultural",
    name: "Cultural",
  ...
  },
  {
    ...
    heads: [{ name: "Kanishk Rathi", image: "/council/Kanishk.jpg", insta: "kanishkrathi029" },
  ...
  },
  {
    id: "academics",
    name: "Academics",
    image: "/commities/logo/academic.jpg",
  ...
  },
  {
    ...
    heads: [{ name: "Metha Bhavya", image: "/council/Bhavya.jpg", insta: "mehtabhavya" },
    ...
    members: [
      ...
      { name: "Harshvardhan Rathore ", image: "/commities/htwf/Harshvardhan.jpg", insta: "" },]
  },
  {
    id: "radio",
    name: "Radio",
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {committeesData.map((team) => (
              <div
                ...
                className="group flex flex-col justify-between rounded-2xl bg-[#0F0F16]/80 backdrop-blur-md border border-white/5 p-6 sm:p-8 min-h-[360px] h-auto cursor-pointer relative z-20 transition-all duration-500 hover:bg-[#151520] hover:-translate-y-2"
            ...
            <div className="mb-16">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {activeTeam.heads.map((head, idx) => (
                  ...
                  >
                    <div className="relative w-full aspect-[4/5] bg-zinc-900 overflow-hidden flex items-center justify-center">
                      {head.image ? (
                        <img src={head.image} alt={head.name} loading="lazy" decoding="async" onError={(e) => { e.currentTarget.style.display = 'none'; }} className="absolute inset-0 w-full h-full object-cover object-[center_15%] transition-transform duration-700 group-hover:scale-105 brightness-110" />
                      ) : (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                  {activeTeam.members.map((member, idx) => (
                    ...
                    >
                      <div className="relative w-full aspect-[4/5] bg-zinc-900 overflow-hidden flex items-center justify-center">
                        {member.image ? (
                          <img src={member.image} alt={member.name} loading="lazy" decoding="async" onError={(e) => { e.currentTarget.style.display = 'none'; }} className="absolute inset-0 w-full h-full object-cover object-[center_15%] transition-transform duration-700 group-hover:scale-105 brightness-110" />
                        ) : (
                          <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10 mix-blend-overlay"></div>
                        )}
